...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "42fVrCA5jppqAx5jtHdHcAkUM1PMaRc2F2cWDaiYp6Uy";
        String sdkKey = "GkpAvJQUiTuf5pQAXuDzBJ54wQEFnArJvEAQNMdFFRHL";


        FaceEngine faceEngine = new FaceEngine("C:\\work\\code_java\\access_control_manage\\access_control_manage\\libs");
        //激活引擎
        ...
        //人脸检测
        ImageInfo imageInfo = getRGBData(new File("C:\\work\\code_java\\access_control_manage\\access_control_manage\\libs\\aaa.jpg"));
